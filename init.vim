...
nnoremap <C-W>x :new<CR>
inoremap <C-D> <esc>:bd<CR>
nnoremap <C-D> :bd<CR>
inoremap php <?php<CR><CR>?><CR><up><up>
inoremap <C-T>c class {<CR>}<CR><left><up><up><right><right><right><right><right><right>
inoremap <C-T>. ->
inoremap pubfu public function () {<CR>}<CR><up><up><right><right><right><right><right><right><right><right><right><right><right><right><right><right><right><right>
inoremap <C-T>t $this->
inoremap <C-Z> <esc>ui
nnoremap <C-S> :w<CR>
inoremap jsd json_decode()<left>
inoremap jse json_encode()<left>
...
nnoremap <C-E> :Tags<CR>
inoremap <C-E> <esc>:Tags<CR>
